...
/* 数组类型 */
// 第一种
var arr1 = [1, 11, 111, 1111];
var arr2 = ['1', '11', '111', '1111'];
var arr3 = [1, '11', [111], { name: 1111 }, true];
// ...
// 第二种
var arr4 = [1, 11, 111, 1111];
var arr5 = ['1', '11', '111', '1111'];
// ...类似第一种写法
...
var state1 = httpCode.ok;
console.log(state1); // 200
// ------------------------------
var err;
(function (err) {
    err[err["enable"] = 0] = "enable";
    err[err["disable"] = 1] = "disable";
    err[err["done"] = 5] = "done";
    err[err["failure"] = 6] = "failure";
})(err || (err = {}));
var state2 = err.enable;
console.log(state2); // 0
var state3 = err.failure;
...
try {
    var n = (function () { throw new Error('返回给你我抛出的异常'); })();
}
catch (error) {
    console.warn(error);
}
